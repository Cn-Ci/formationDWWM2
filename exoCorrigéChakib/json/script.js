// lancement de la page: afficher le tableau avec toutes les voitures
let maReponse;
...
// Au changement de la marque, mise à jour des modèles disonibles et aussi le tableau
...
// Au changement du modèle, mise à jour du tableau uniquement
$("#modele").on("change", function(e){
    ...
    let url = modeleSelectionne ?
        "db_voitures.php?marque=" + marqueSelectionnee + "&modele=" + modeleSelectionne
        :
        "db_voitures.php?marque=" + marqueSelectionnee;
    doGetJson(url, false);
})
